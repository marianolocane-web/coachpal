...
export function DayMoodRing({ label, emoji, progress = 0, alert = false, onClick, size = 64 }) {
  const r = (size - 6) / 2;
  ...
  return (
    <button
      ...
      style={{
        ...
        background: 'none', border: 'none', cursor: onClick ? 'pointer' : 'default', fontFamily: 'var(--font-body)',
      }}
    >
