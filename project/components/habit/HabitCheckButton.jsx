...
export function HabitCheckButton({ done, onClick, size = 40 }) {
  return (
    <button
      type="button"
      onClick={onClick}
      ...
      onMouseUp={(e) => { e.currentTarget.style.transform = 'scale(1.06)'; setTimeout(() => { e.currentTarget.style.transform = 'scale(1)'; }, 120); }}
    >
      {done && (
